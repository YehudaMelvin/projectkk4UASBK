...
class ReservasiController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($reservasi){
            ...
            $reservasi->telp = $request->telp ? $request->telp : $reservasi->telp;
            $reservasi->type = $request->type ? $request->type : $reservasi->type;
            $reservasi->jmlh_pesan = $request->jmlh_pesan ? $request->jmlh_pesan : $reservasi->jmlh_pesan;
